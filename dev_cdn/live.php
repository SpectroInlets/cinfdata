...
if (isset($settings["page_title"])){
  ...
  echo(html_header_dev($root="../", $title=$settings["page_title"], $includehead=$include_head, $charset="UTF-8", $width=$settings["page_width"]));
} else {
  echo(html_header_dev($root="../", $title="Live Plots", $includehead=$include_head, $charset="UTF-8", $width=$settings["page_width"]));
}
