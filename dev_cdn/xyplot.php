...
$query = "SELECT id, time, " . $settings["label_column"] . " FROM " .  $settings["measurements_table"] . " where " . $settings["grouping_column"] . " in (" . $sql_times . ") and type = " . $settings["type"] . " order by " . $settings["sort_dataset_by_column"] . " desc, id limit 8000";
...
echo(html_header_dev($root="../", $page_title="Data viewer", $includehead="", $charset=$charset));
